...
const Navbar = () => {
    ...
    return (
      <header className="fixed top-0 inset-x-0 z-50 h-20 flex items-center bg-transparent ">
    ...
    <Link href="/" className="flex items-center gap-x-4 text-2xl font-semibold uppercase text-gray-950 flex-col ml-1">   
      ...
      <span className="text-center text-sm">Property Developers</span>
            ...
            <div
          className={`
                flex flex-col space-y-10 inset-0 fixed top-0 h-[100dvh] bg-white lg:!bg-transparent py-20 px-5 sm:px-10 md:px-14
            ...
            >
              ...
              <div className="w-full flex sm:w-max lg:min-w-max lg:items-center">
                <Link
                  href="#"
                  className="flex justify-center gap-x-3 items-center uppercase italic text-gray-300 hover:text-gray-900 border-b bg-gray-700 hover:border-b-gray-900 bg-transparent mt-2"
                >
                  Contact Us
                  <span>
