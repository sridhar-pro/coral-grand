    ...
    <>
     <section className="py-4 lg:py-0  mt-10 md:mt-0 lg:mt-14 bg-gradient-to-bl from-white to-white">
      ...
      <motion.div
        ...
        initial="offscreen"
        animate="onscreen"
        className="flex aspect-square lg:aspect-auto h-[20rem] tablet:h-[30rem] lg:h-[35rem] relative mt-44 tablet:mt-0 md:mt-6 lg:mt-16 z-10 ml-0 md:ml-0 lg:ml-0 tablet:ml-20"
      >
        <motion.div
